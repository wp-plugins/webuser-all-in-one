...
?>
		<?php if (strpos($this->get_login_url(), $_SERVER['SERVER_NAME']) !== false): ?>
			<p class="galogin"> 
		...
		jQuery(document).ready(function(){
			...
			<?php 
			if (strpos($this->get_login_url(), $_SERVER['SERVER_NAME']) !== false): ?>
	        	loginform.append(googlelink);
			<?php endif; ?>
	        <?php 
	        	$fntxt = ob_get_clean(); 
