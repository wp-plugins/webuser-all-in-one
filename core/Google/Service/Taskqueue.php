 ...
 * @author Google, Inc.
 */
class GoogleGAL_Service_Taskqueue extends GoogleGAL_Service
{
  ...
  public function __construct(GoogleGAL_Client $client)
  {
    ...
    $this->taskqueues = new GoogleGAL_Service_Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new GoogleGAL_Service_Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new GoogleGAL_Service_Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class GoogleGAL_Service_Taskqueue_Taskqueues_Resource extends GoogleGAL_Service_Resource
{
   ...
   * @return GoogleGAL_Service_Taskqueue_TaskQueue
   */
  public function get($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "GoogleGAL_Service_Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class GoogleGAL_Service_Taskqueue_Tasks_Resource extends GoogleGAL_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return GoogleGAL_Service_Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "GoogleGAL_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return GoogleGAL_Service_Taskqueue_Task
   */
  public function insert($project, $taskqueue, GoogleGAL_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "GoogleGAL_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return GoogleGAL_Service_Taskqueue_Tasks
   */
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "GoogleGAL_Service_Taskqueue_Tasks");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return GoogleGAL_Service_Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "GoogleGAL_Service_Taskqueue_Tasks2");
  }
  /**
   ...
   * @return GoogleGAL_Service_Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, GoogleGAL_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "GoogleGAL_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return GoogleGAL_Service_Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, GoogleGAL_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "GoogleGAL_Service_Taskqueue_Task");
  }
}
...
class GoogleGAL_Service_Taskqueue_Task extends GoogleGAL_Model
{
...
class GoogleGAL_Service_Taskqueue_TaskQueue extends GoogleGAL_Model
{
  protected $aclType = 'GoogleGAL_Service_Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'GoogleGAL_Service_Taskqueue_TaskQueueStats';
  protected $statsDataType = '';

  public function setAcl(GoogleGAL_Service_Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(GoogleGAL_Service_Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class GoogleGAL_Service_Taskqueue_TaskQueueAcl extends GoogleGAL_Collection
{
  public $adminEmails;
...
class GoogleGAL_Service_Taskqueue_TaskQueueStats extends GoogleGAL_Model
{
...
class GoogleGAL_Service_Taskqueue_Tasks extends GoogleGAL_Collection
{
  protected $itemsType = 'GoogleGAL_Service_Taskqueue_Task';
...
class GoogleGAL_Service_Taskqueue_Tasks2 extends GoogleGAL_Collection
{
  protected $itemsType = 'GoogleGAL_Service_Taskqueue_Task';
  protected $itemsDataType = 'array';
  public $kind;
