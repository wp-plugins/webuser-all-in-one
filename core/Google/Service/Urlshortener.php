...
class GoogleGAL_Service_Urlshortener extends GoogleGAL_Service
{
  ...
  public function __construct(GoogleGAL_Client $client)
  {
    ...
    $this->url = new GoogleGAL_Service_Urlshortener_Url_Resource(
        $this,
        $this->serviceName,
        'url',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $urlshortenerService = new GoogleGAL_Service_Urlshortener(...);
 *   $url = $urlshortenerService->url;
 *  </code>
 */
class GoogleGAL_Service_Urlshortener_Url_Resource extends GoogleGAL_Service_Resource
{
   ...
   *
   * @param GoogleGAL_Url $postBody
   * @param array $optParams Optional parameters.
   * @return GoogleGAL_Service_Urlshortener_Url
   */
  public function insert(GoogleGAL_Service_Urlshortener_Url $postBody, $optParams = array())
  {
  ...
  public function listUrl($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "GoogleGAL_Service_Urlshortener_UrlHistory");
  }
}
...
class GoogleGAL_Service_Urlshortener_AnalyticsSnapshot extends GoogleGAL_Collection
{
  ...
  protected $platformsType = 'GoogleGAL_Service_Urlshortener_StringCount';
  protected $platformsDataType = 'array';
  protected $referrersType = 'GoogleGAL_Service_Urlshortener_StringCount';
...
class GoogleGAL_Service_Urlshortener_AnalyticsSummary extends GoogleGAL_Model
{
  ...
  protected $monthType = 'GoogleGAL_Service_Urlshortener_AnalyticsSnapshot';
  protected $monthDataType = '';
  protected $twoHoursType = 'GoogleGAL_Service_Urlshortener_AnalyticsSnapshot';
