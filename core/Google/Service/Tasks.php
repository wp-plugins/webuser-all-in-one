 ...
 * @author Google, Inc.
 */
class GoogleGAL_Service_Tasks extends GoogleGAL_Service
{
  /** Manage your tasks. */
  ...
  public function __construct(GoogleGAL_Client $client)
  {
    ...
    $this->tasklists = new GoogleGAL_Service_Tasks_Tasklists_Resource(
        $this,
        $this->serviceName,
        'tasklists',
        array(
    ...
    $this->tasks = new GoogleGAL_Service_Tasks_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tasksService = new GoogleGAL_Service_Tasks(...);
 *   $tasklists = $tasksService->tasklists;
 *  </code>
 */
class GoogleGAL_Service_Tasks_Tasklists_Resource extends GoogleGAL_Service_Resource
{
   ...
   * Task list identifier.
   * @param array $optParams Optional parameters.
   * @return GoogleGAL_Service_Tasks_TaskList
   */
  public function get($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "GoogleGAL_Service_Tasks_TaskList");
  }
  /**
   * Creates a new task list and adds it to the authenticated user's task lists.
   * (tasklists.insert)
   *
   * @param GoogleGAL_TaskList $postBody
   * @param array $optParams Optional parameters.
   * @return GoogleGAL_Service_Tasks_TaskList
   */
  public function insert(GoogleGAL_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "GoogleGAL_Service_Tasks_TaskList");
  }
  /**
   ...
   * @return GoogleGAL_Service_Tasks_TaskLists
   */
  public function listTasklists($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "GoogleGAL_Service_Tasks_TaskLists");
  }
  /**
   ...
   * @return GoogleGAL_Service_Tasks_TaskList
   */
  public function patch($tasklist, GoogleGAL_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "GoogleGAL_Service_Tasks_TaskList");
  }
  /**
   ...
   * @return GoogleGAL_Service_Tasks_TaskList
   */
  public function update($tasklist, GoogleGAL_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "GoogleGAL_Service_Tasks_TaskList");
  }
}
 ...
 *  </code>
 */
class GoogleGAL_Service_Tasks_Tasks_Resource extends GoogleGAL_Service_Resource
{
   ...
   * Task identifier.
   * @param array $optParams Optional parameters.
   * @return GoogleGAL_Service_Tasks_Task
   */
  public function get($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "GoogleGAL_Service_Tasks_Task");
  }
  /**
   ...
   * @return GoogleGAL_Service_Tasks_Task
   */
  public function insert($tasklist, GoogleGAL_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "GoogleGAL_Service_Tasks_Task");
  }
  /**
   ...
   * Lower bound for a task's due date (as a RFC 3339 timestamp) to filter by. Optional. The default
    * is not to filter by due date.
   * @return GoogleGAL_Service_Tasks_Tasks
   */
  public function listTasks($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "GoogleGAL_Service_Tasks_Tasks");
  }
  /**
  ...
  public function move($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "GoogleGAL_Service_Tasks_Task");
  }
  /**
   ...
   * @return GoogleGAL_Service_Tasks_Task
   */
  public function patch($tasklist, $task, GoogleGAL_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "GoogleGAL_Service_Tasks_Task");
  }
  /**
   ...
   * @return GoogleGAL_Service_Tasks_Task
   */
  public function update($tasklist, $task, GoogleGAL_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "GoogleGAL_Service_Tasks_Task");
  }
}
...
class GoogleGAL_Service_Tasks_Task extends GoogleGAL_Collection
{
  public $completed;
  public $deleted;
  public $due;
  ...
  public $id;
  public $kind;
  protected $linksType = 'GoogleGAL_Service_Tasks_TaskLinks';
...
class GoogleGAL_Service_Tasks_TaskLinks extends GoogleGAL_Model
{
  public $description;
  public $link;
  public $type;
...
class GoogleGAL_Service_Tasks_TaskList extends GoogleGAL_Model
{
  public $etag;
  public $id;
  public $kind;
...
class GoogleGAL_Service_Tasks_TaskLists extends GoogleGAL_Collection
{
  public $etag;
  protected $itemsType = 'GoogleGAL_Service_Tasks_TaskList';
...
class GoogleGAL_Service_Tasks_Tasks extends GoogleGAL_Collection
{
  public $etag;
  protected $itemsType = 'GoogleGAL_Service_Tasks_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
